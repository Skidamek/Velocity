...
public class RegisteredUser {
     ...
     * Note that the parameters of this method represent "NOT NULL" fields in the table and thus should not be null.
     */
    public static RegisteredUser createAndAdd(String username, String password) throws Exception {
        int id = idCounter.getAndIncrement();
        RegisteredUser obj = new RegisteredUser(id, username, password);
        add(obj);
        return obj;
     ...
     */
    public static List<RegisteredUser> get() throws Exception {
        return get(null);
    }
    ...
    public static class WHERE {
         ...
         */
        public List<RegisteredUser> get() throws Exception {
