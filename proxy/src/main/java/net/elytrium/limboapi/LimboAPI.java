...
public class LimboAPI implements PluginContainer, LimboFactory {
  ...
  public PluginDescription getDescription() {
    return new PluginDescription() {
      ...
      public Optional<String> getDescription() {
        return Optional.of("Manages virtual limbo servers.");
      }

      @Override
      public List<String> getAuthors() {
        return Collections.singletonList("Elytrium");
      }
    };
  }
  ...
  public LimboAPI(Logger logger, ProxyServer server, @DataDirectory Path dataDirectory) {
    setLogger(logger);
